      ...
      {isOpen && (
        ...
        >
          <div className="relative flex h-full max-h-[760px] w-full max-w-[1180px] flex-col overflow-hidden rounded-[28px] border border-[#854F6C] bg-[#190019] shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
            ...
            <div className="relative z-10 grid min-h-0 flex-1 grid-cols-1 overflow-y-auto md:grid-cols-[320px_minmax(0,1fr)_100px] md:overflow-hidden">
              <aside className="border-b border-[#854F6C]/50 bg-[#2B124C]/55 p-4 md:border-b-0 md:border-r flex flex-col justify-between custom-scrollbar overflow-y-auto">
                <div>
                  <div className="mb-4 flex items-center gap-3 border-b border-[#854F6C]/50 pb-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#DFB6B2] text-[#190019] shadow-[2px_2px_0_#190019] text-sm font-bold">☾</div>
                    <div>
                      <p className="text-[9px] uppercase tracking-[0.3em] text-[#DFB6B2]/70">TARDIS</p>
                      <h2 className="text-xs font-bold text-[#FBE4D8]">Resting Quarters</h2>
                    </div>
                  </div>
                  <MediaWidget />
                </div>
